...
<div class="page-inner">
  <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
    <div>
      <h3 class="fw-bold mb-3">Unit Kerja</h3>
      <h6 class="op-7 mb-2">Pengelolaan data unit kerja</h6>
    </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nama" name="nama" placeholder="nama unit kerja" required>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="is_pilihan">Pilih</label><br>
                      <select class="form-control" id="is_pilihan" name="is_pilihan" required>
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" class="form-control" rows="5" name="keterangan" id="keterangan" ></textarea>
                    </div>
...
<script>
  const endpoint = base_url+'/api/unit-kerja';
  var page = 1;
  ...
  $(document).ready(function() {
    ...
    function dataUnitKerja() {
      ...
      fetchData(url, function(response) {
        renderSelect(response.data,'#parent_id', 'id', ['nama']);
      },false);
    }
    ...
    $(document).on('click', '.btn-ganti', function() {
      ...
      showDataById(endpoint, id, function(response) {
        ...
        $('#is_pilihan').val(response.data.is_pilihan);            
        showModalForm();
      });
    });
